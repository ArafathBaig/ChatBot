...
#Splitting the data into batches of questions and answer
...
#Splitting the questions into training and validation set
...
#Loading theweights and Running the session
checkpoint = "./chatbot_weights.ckpt"
session = tf.InteractiveSession()
session.run(tf.global_variables_initializer())
saver = tf.train.Saver()
...
#Converting the questions from the String to list of encoding integers
